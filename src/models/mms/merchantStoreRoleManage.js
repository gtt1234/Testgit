import * as service from '../../services/mms/merchantStoreRole';
...
// 基础配置信息
const namespace = 'merchantStoreRoleManage';
const objectId = 'roleId';
const enterPath = '/mms/memberRoleManage/merchantStoreRoleManage';
// 基础公共信息
