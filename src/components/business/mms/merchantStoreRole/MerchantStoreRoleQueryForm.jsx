...
const MerchantStoreRoleQueryForm = (props) => {
...
MerchantStoreRoleQueryForm.propTypes = {
  formSubmit: PropTypes.func,
};

MerchantStoreRoleQueryForm.defaultProps = {
  advExpand: false,
  collapseClick: noop,
  formSubmit: noop,
  enableClick: noop,
...
export default Form.create()(MerchantStoreRoleQueryForm);
