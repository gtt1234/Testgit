...
const MerchantRolePageTable = (props) => {
  ...
  const tableProps = {
    ...
    tableColumns: [
      ...
      { title: bizMap.roleMerName, dataIndex: 'roleMerName', width: 100 },
...
MerchantRolePageTable.propTypes = {
...
MerchantRolePageTable.defaultProps = {
  tableCurrentPage: 1,
  tableList: [],
  tableTotal: 0,
  tableLoading: false,
...
export default MerchantRolePageTable;
