...
const PersonalMemberBaseInfoForm = (props) => {
...
PersonalMemberBaseInfoForm.propTypes = {
...
PersonalMemberBaseInfoForm.defaultProps = {
  data: {},
  loading: false,
  submiting: false,
  formSubmit: noop,
...
export default Form.create()(PersonalMemberBaseInfoForm);
