...
const PersonalMemberInfoForm = (props) => {
...
PersonalMemberInfoForm.propTypes = {
...
PersonalMemberInfoForm.defaultProps = {
  data: {},
  loading: false,
  submiting: false,
  formSubmit: noop,
...
export default Form.create()(PersonalMemberInfoForm);
